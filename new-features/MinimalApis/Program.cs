...
WriteLine("Hi I am Billy");

string[] workingWith = new string[] {"C#", "dotnet", "aspnet core", "azure", "blazor", "rider", "vscode", "vs"};

WriteLine($"I am a .net developer working with {string.Join(",", workingWith)}");
